                      ...
                      >
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                          <div style={{
                            ...
                            {!preview
                              ? <Lock style={{ width: 9, height: 9, color: BRAND }} />
                              : active
                  ...
                  {isEnrolled ? (
                    ...
                    <>
                      ...
                      <Link href={isLoggedIn ? loggedInCtaHref : enrollHref} style={{
                        ...
                        {isLoggedIn ? <><Lock style={{ width: 13, height: 13 }} /> Enroll Now</> : <><LogIn style={{ width: 13, height: 13 }} /> Enroll Now</>}
                      </Link>
                    </>
                  ) : (
                    <>
