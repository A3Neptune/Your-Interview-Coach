...
/* ─── Coaching Banner (shown after analysis if score < 80) ── */
    ...
    <div className="max-w-[1120px] mx-auto px-6 mb-10">
      <div
        className={`relative overflow-hidden rounded-2xl border ${
          isLow
            ? "bg-[#0F172A] border-[#1A3BCC]/30"
            : "bg-white border-[#1A3BCC]/20"
        }`}
      >
        {/* Grid texture */}
        <div
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${
              isLow ? "rgba(26,59,204,0.28)" : "rgba(26,59,204,0.07)"
            } 0%, transparent 70%)`,
          }}
        />
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6 p-6 lg:p-8">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            >
              <p className={`text-[10px] font-extrabold tracking-[0.08em] uppercase mb-0.5 ${isLow ? "text-red-400" : "text-amber-600"}`}>
                Your Score
              </p>
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className={`text-lg lg:text-xl font-extrabold tracking-[-0.02em] mb-2 leading-snug ${isLow ? "text-white" : "text-[#0F172A]"}`}>
              {isLow
                ? "A score this low gets auto-rejected before any human sees your name."
                : "Good foundation — but competitive firms filter at 80+."
              }
            </h3>
          ...
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-3 flex-shrink-0 w-full md:w-auto">
            <Link
              ...
              className={`inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-[13px] no-underline transition-all duration-200 hover:-translate-y-0.5 ${
                isLow
                  ? "text-[#0F172A] bg-white hover:shadow-[0_8px_24px_rgba(26,59,204,0.28)]"
                  : "text-white bg-[#1A3BCC] hover:shadow-[0_8px_24px_rgba(26,59,204,0.35)]"
              }`}
            >
            ...
            <Link
              ...
              className={`inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold text-[13px] no-underline transition-colors duration-200 ${
                isLow
                  ? "text-white/70 border border-white/15 hover:bg-white/[0.06]"
                  : "text-[#1A3BCC] border border-[#1A3BCC]/25 hover:bg-[#1A3BCC]/5"
              }`}
            >
        ...
        {/* Bottom stat strip */}
        <div
          className={`border-t px-6 lg:px-8 py-3.5 flex items-center gap-6 flex-wrap ${
            isLow ? "border-white/[0.06]" : "border-[#1A3BCC]/[0.08]"
          }`}
        >
          {[
            ...
            return (
              <div key={i} className="flex items-center gap-1.5">
                ...
                <span className={`text-[12px] font-semibold ${isLow ? "text-white/40" : "text-slate-400"}`}>
                  {item.label}
                </span>
              </div>
            );
    ...
    <div className="font-[DM_Sans,sans-serif] bg-[#F8F7F3] min-h-screen overflow-x-hidden text-[#0F172A]">
      ...
      {analysisData ? (
        ...
        <main className="pt-20 pb-12 bg-[#F8F7F3]">
          {/* Coaching banner slides in above results */}
        ...
        <>
          ...
          <section className="min-h-screen flex flex-col justify-center pt-[90px] pb-16 px-6 relative overflow-hidden">
            ...
            <div className="max-w-[1120px] mx-auto w-full relative z-10">
              <div
                className="hero-in inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#1A3BCC]/25 bg-[#1A3BCC]/5 mb-10"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <div className="hero-in" style={{ animationDelay: "120ms" }}>
                    <div className="text-[clamp(60px,9vw,104px)] font-black leading-none tracking-[-0.04em] text-[#0F172A] mb-6">
                ...
                <div className="hero-in relative" style={{ animationDelay: "300ms" }}>
                  <div className="bg-white border border-[#1A3BCC]/[0.12] rounded-2xl p-7 shadow-[0_2px_40px_rgba(0,0,0,0.06)] relative overflow-hidden">
                    <div className="flex items-center justify-between mb-5 pb-4 border-b border-[#1A3BCC]/[0.08]">
                      <div>
                        <p className="text-[10px] font-extrabold text-[#1A3BCC] tracking-[0.1em] uppercase mb-0.5">Resume Report</p>
                        <p className="text-[13px] font-bold text-[#0F172A]">ATS Compatibility Analysis</p>
                      </div>
                      <div className="px-2.5 py-1 rounded-md bg-emerald-500/[0.08] border border-emerald-500/[0.2]">
                        <span className="text-[11px] font-bold text-emerald-600 tracking-[0.06em]">COMPLETE</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-5 mb-5 pb-5 border-b border-[#1A3BCC]/[0.06]">
                      <div className="pulse-ring w-16 h-16 rounded-full bg-[#1A3BCC] flex items-center justify-center flex-shrink-0">
                        <span className="text-[22px] font-black text-white leading-none">87</span>
                      </div>
                      <div className="flex-1">
                        <p className="text-[11px] font-extrabold text-[#1A3BCC] tracking-[0.08em] uppercase mb-1">ATS Score</p>
                        <div className="w-full h-2 rounded-full bg-slate-100 overflow-hidden">
                          <div className="h-full w-[87%] rounded-full bg-gradient-to-r from-[#1A3BCC] to-blue-400" />
                        </div>
                        <p className="text-[11px] text-slate-400 mt-1">Above average — 3 critical fixes found</p>
                      </div>
                    </div>
                    {[
                      { label: "Structure", score: 82, color: "bg-[#1A3BCC]" },
                      { label: "Keywords", score: 91, color: "bg-violet-500" },
                      { label: "Clarity", score: 78, color: "bg-cyan-500" },
                      { label: "Sections", score: 95, color: "bg-emerald-500" },
                    ].map((row, i) => (
                      <div key={i} className="flex items-center gap-3 mb-3">
                        <span className="text-[12px] font-bold text-slate-500 w-[72px] flex-shrink-0">{row.label}</span>
                        <div className="flex-1 h-1.5 rounded-full bg-slate-100 overflow-hidden">
                          <div className={`h-full rounded-full ${row.color}`} style={{ width: `${row.score}%` }} />
                        </div>
                        <span className="text-[12px] font-extrabold text-[#0F172A] w-8 text-right">{row.score}</span>
                      </div>
                    ))}
                    <div className="mt-4 p-3.5 rounded-[10px] bg-amber-500/[0.05] border border-amber-500/[0.15]">
                      <p className="text-[11px] font-bold text-amber-600 tracking-[0.06em] uppercase mb-1">Top Issue</p>
                  ...
                  <div className="absolute -bottom-3.5 left-6 bg-[#1A3BCC] rounded-lg px-3.5 py-1.5 flex items-center gap-1.5">
                    <span className="text-[11px] font-bold text-white">This is what you'll get.</span>
                  </div>
                  <div className="float-a absolute -top-4 -right-4 bg-white border border-[#1A3BCC]/15 rounded-xl px-3 py-2 shadow-md hidden lg:flex items-center gap-2">
                    <Zap className="w-3.5 h-3.5 text-[#1A3BCC]" />
                    <span className="text-[12px] font-bold text-[#0F172A]">Results in ~10s</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="upload" className="py-24 px-6 bg-white">
            <div className="max-w-[860px] mx-auto">
              <Reveal>
                <p className="text-[11px] font-extrabold text-[#1A3BCC] tracking-[0.1em] uppercase mb-2.5 text-center">Upload</p>
                <h2 className="text-[clamp(28px,4vw,48px)] font-extrabold text-[#0F172A] leading-[1.1] tracking-[-0.03em] text-center mb-3">
                  Drop your resume here.
                </h2>
                <p className="text-sm text-slate-500 text-center leading-[1.75] mb-10 max-w-[420px] mx-auto">
                  PDF or DOCX accepted. No account needed. No data stored after analysis.
                </p>
              </Reveal>
              <Reveal delay={80}>
                  ...
                  {[
                    ...
                    return (
                      <div key={i} className="flex items-center gap-2">
                        <Icon className="w-4 h-4 text-[#1A3BCC]/50" />
                        <span className="text-[13px] font-medium text-slate-400">{t.text}</span>
                      </div>
                    );
                  })}
                </div>
