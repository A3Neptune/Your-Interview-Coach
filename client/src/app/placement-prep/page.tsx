                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <div style={{ position: "relative", width: "100%", maxWidth: 320 }}>
                    <div style={{
                      ...
                      boxShadow: "0 28px 72px rgba(37,99,235,0.18)",
                    }}>
                      <Image src="/neel-new.jpeg" alt="Neel Aashish Seru" fill className="object-cover object-center" />
                      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom,transparent 55%,rgba(15,23,42,0.22) 100%)" }} />
                    </div>
                    <div style={{
