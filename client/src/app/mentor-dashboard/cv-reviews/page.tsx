    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-2">
          Track and manage student CV reviews
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={idx}
            className={`bg-gradient-to-br ${stat.color} to-transparent border border-zinc-800 rounded-lg p-6`}
          >
      ...
      <div className="space-y-4">
        {reviews.length === 0 ? (
          ...
          reviews.map((review) => (
            <div
              key={review.id}
              className="bg-gradient-to-br from-zinc-900 via-zinc-900/50 to-black border border-zinc-800 rounded-2xl p-6 hover:border-zinc-700 transition group"
            >
              <div className="flex items-start justify-between">
      ...
      <div className="bg-gradient-to-br from-zinc-900 via-zinc-900/50 to-black border border-zinc-800 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <label
              key={idx}
              className="flex items-center gap-3 p-3 rounded-lg hover:bg-zinc-800/50 cursor-pointer transition"
            >
              <input
                type="checkbox"
                defaultChecked
