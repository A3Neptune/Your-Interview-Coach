...
import { Briefcase, MapPin, Users, DollarSign, Clock, Filter, Search, Send, Zap } from 'lucide-react';
      ...
      <div className="bg-gradient-to-br from-zinc-900 via-zinc-900/50 to-black border border-zinc-800 rounded-2xl p-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-zinc-300">Update your profile with skills and experience to get automatic job recommendations that match your expertise. We'll notify you via email when jobs match your profile!</p>
          </div>
        </div>
      </div>
    </div>
