...
function ServiceCardSkeleton() {
  return (
    <div className="flex flex-col sm:flex-row rounded-2xl overflow-hidden border border-slate-100">
      <div className="sm:w-64 shrink-0 bg-slate-200 p-5 space-y-3">
        <Shimmer className="h-5 w-3/4 bg-slate-300" />
        <Shimmer className="h-3 w-full bg-slate-300" />
        <Shimmer className="h-3 w-2/3 bg-slate-300" />
        <div className="flex gap-2 pt-2">
          <Shimmer className="h-5 w-16 rounded-full bg-slate-300" />
          <Shimmer className="h-5 w-16 rounded-full bg-slate-300" />
        </div>
      </div>
      <div className="flex-1 bg-white p-5 flex flex-col sm:flex-row gap-5">
        <div className="flex-1 space-y-2">
          {[1, 2, 3, 4].map((i) => (
...
const PALETTES = [
  ...
  },
  {
    ...
    ctaBg: "from-violet-600 to-violet-900",
  },
  {
    ...
    ctaBg: "from-emerald-600 to-emerald-900",
  },
  {
    ...
    ctaBg: "from-amber-600 to-amber-900",
  },
];
...
export default function DashboardPage() {
  ...
  // ─── Global spinner only if user hasn't loaded yet ───────────────────────
  if (isLoading && !user) {
    return (
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 overflow-hidden">
          {/* Decorative blobs */}
          <div className="absolute -top-16 -right-16 w-64 h-64 bg-blue-500/30 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-1/3 w-48 h-48 bg-blue-800/40 rounded-full blur-2xl pointer-events-none" />
          {/* Subtle dot grid */}
          <div
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 fade-up">
              <div>
              ...
              <button
                ...
                className="group flex items-center gap-2 px-5 py-3 bg-white text-blue-700 rounded-xl font-semibold text-sm shadow-lg hover:shadow-xl hover:bg-blue-50 transition-all duration-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 fade-up fade-up-1">
            ...
            {isLoading ? (
              ...
              <div className="col-span-2 lg:col-span-1 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow p-6">
                <div className="flex items-center gap-4">
                  {user.profileImage ? (
                    <img
                      src={user.profileImage}
                    ...
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shrink-0 shadow-md">
            ...
            {isLoading ? (
              ...
              <div
                ...
                className="rounded-2xl border border-dashed border-blue-300 bg-blue-50/60 hover:bg-blue-50 hover:border-blue-400 transition-all cursor-pointer p-6 flex flex-col justify-between group"
              >
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {isLoading
                  ...
                  : upcomingBookings.map((booking) => (
                      <div
                        key={booking._id}
                        className="rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-200 p-5 flex flex-col gap-4"
                      >
                        {/* Header */}
                        <div className="flex items-center justify-between">
                        ...
                        {booking.meetingLink && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-auto flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-xs font-semibold shadow-sm hover:shadow-md transition-all"
                          >
          ...
          <section id="services-section" className="scroll-mt-8 fade-up fade-up-3">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-400 text-xs mt-0.5">
                  Pick a service and choose your time slot
                </p>
              </div>
            </div>
                ...
                {services.map((service, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* Left dark panel */}
                      <div
                        className={`bg-gradient-to-br ${p.gradient} p-5 sm:w-64 shrink-0 flex flex-col justify-between gap-4`}
                      >
                        <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {service.duration && (
                            <span className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/10 text-white text-[11px] font-medium">
                              <Clock className="w-3 h-3" />
                              {service.duration}
                            </span>
                          )}
                          {service.level && (
                            <span className="px-2.5 py-1 rounded-full bg-white/10 text-white text-[11px] font-medium">
                              {service.level}
                            </span>
                          )}
                          {service.support && (
                      ...
                      {/* Right white panel */}
                      <div className="flex-1 bg-white p-5 flex flex-col sm:flex-row gap-6">
                        {/* Feature list */}
                        {service.points?.length > 0 && (
                          <ul className="flex-1 space-y-2 self-start">
                            {service.points.slice(0, 4).map((pt, i) => (
                              ...
                              >
                                <CheckCircle2
                                  className={`w-3.5 h-3.5 mt-0.5 shrink-0 ${p.checkColor}`}
                                />
                                {pt}
                              </li>
                            ))}
