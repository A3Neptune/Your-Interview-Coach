...
export default function CourseDetailPage() {
  ...
  const FREE_PREVIEW_COUNT = 2; // first N lessons always free to preview
  ...
  const renderPlayer = () => {
    ...
    // free preview banner (non-enrolled user watching preview lesson)
                  ...
                  {contents.map((c, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {locked && <span style={{ fontSize: 9.5, color: "#94a3b8", fontWeight: 600, display: "flex", alignItems: "center", gap: 3 }}><Lock style={{ width: 8, height: 8 }} /> Enroll to unlock</span>}
