...
export default function CourseDetailPage() {
  ...
  // never flashes for an enrolled user before the check resolves.
  const canWatch        = isLoading || !isPaidCourse || isEnrolled || isPreviewLesson;
  ...
  const renderPlayer = () => {
    ...
    // Never show the "enroll for full access" nudge while the enrollment check
    // is still in-flight — isEnrolled is false by default and would show the banner
    // to enrolled users until the request resolves.
    const previewBanner = !isLoading && isPreviewLesson && isPaidCourse && !isEnrolled ? (
      <div style={{
            ...
            <div className="sidebar-col mod-list">
              ...
              <div style={{
                ...
                <div style={{ padding: "16px 18px", display: "flex", flexDirection: "column", gap: 13 }}>
                  ...
                  {/* Enroll / enrolled status
                      Intentionally hidden while isLoading — enrollment check runs inside
                      the same load() call, so isEnrolled is not reliable until loading=false.
                      Showing a shimmer prevents a flash of "Enroll" for already-enrolled users. */}
                  {isLoading ? (
                    <div className="shimmer" style={{ height: 40, borderRadius: 11 }} />
                  ) : isEnrolled ? (
                    <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {/* Only show "Locked" once enrollment status is confirmed */}
                    ...
                    {moduleGroups.map((group, gi) => (
                      <div key={gi}>
                        ...
                        {group.items.map((c) => {
                          ...
                          // Don't lock lessons while enrollment check is in-flight — avoids
                          // premature "locked" state flash for enrolled users.
                          const locked    = !isLoading && isPaidCourse && !isEnrolled && !isPreview;
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                // No opacity reduction — locked lessons render at full colour
                                fontFamily: "inherit",
                                textAlign: "left",
                            ...
                            >
                              ...
                              <div style={{
                                ...
                                display: "flex", alignItems: "center", justifyContent: "center",
                                ...(locked
                                  ? { background: "rgba(37,99,235,0.07)", border: "1.5px solid rgba(29,78,216,0.18)" }
                                  : done
                                    ? { background: "#10b981" }
                                    : active
                                      ? { background: BRAND }
                                ...
                                {locked
                                  ? <Lock style={{ width: 10, height: 10, color: BRAND }} />
                                  : done
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 3 }}>
                                  ...
                                  {locked && (
                                    <span style={{
                                      ...
                                      fontSize: 9, fontWeight: 600, color: BRAND,
                                    }}>
