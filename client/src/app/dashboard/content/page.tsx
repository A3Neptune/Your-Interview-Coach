...
function EnrolledCard({ course }: { course: Course }) {
  ...
  const accent = isDone ? '#059669' : BRAND;
  const accentLight = isDone ? 'rgba(5,150,105,0.07)' : 'rgba(37,99,235,0.07)';
  const accentBorder = isDone ? 'rgba(5,150,105,0.2)' : 'rgba(37,99,235,0.18)';
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 3, background: isDone ? 'linear-gradient(90deg,#10b981,#05966955,transparent)' : `linear-gradient(90deg,${BRAND},${BRAND_DEEP}55,transparent)`, flexShrink: 0 }} />
