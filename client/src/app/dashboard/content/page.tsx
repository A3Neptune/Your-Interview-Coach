    ...
    >
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: 10, right: 10 }}>
          {isEnrolled
            ? null /* hide price badge once enrolled */
            : isPaid
              ? <span style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, padding: '16px 18px 18px', gap: 10 }}>
        ...
        <div style={{ marginTop: 4, display: 'flex', gap: 8 }}>
          {isEnrolled ? (
            /* Already enrolled — just show Continue/Review */
            ...
            /* Paid + not enrolled: show price + Buy Now */
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 7 }}>
                <span style={{ fontSize: 19, fontWeight: 800, color: INK, letterSpacing: '-0.03em' }}>
                  {course.price > 0 ? `₹${course.price}` : 'Paid'}
                </span>
                {course.price > 0 && <span style={{ fontSize: 10, color: '#94a3b8', fontWeight: 500 }}>+ GST</span>}
              </div>
