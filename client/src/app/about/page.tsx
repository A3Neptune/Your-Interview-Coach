...
const milestones = [
  {
    ...
    desc: "Arjun and Priya met at a Google careers panel and realised the same thing: most candidates were wildly underprepared, not because of ability — but because they had no real feedback.",
  },
  {
    year: "2021",
    title: "Built in a Weekend",
    desc: "First version: a Notion doc, a Calendly link, and two coaches. 40 beta users. 38 got offers. The waiting list grew before the product did.",
  },
  {
    year: "2022",
    title: "AI Enters the Room",
    desc: "Rohan joined to build the AI feedback engine. Practice sessions became available 24/7. Candidates could rehearse at 2am before a 9am interview.",
  },
  {
    year: "2023",
    title: "Scale & Depth",
    desc: "Crossed 5,000 coached candidates. Expanded into finance, consulting, and design tracks. Partnered with 100+ companies for referral pipelines.",
  },
  {
    year: "2024",
    title: "The Platform",
    desc: "Launched the full dashboard, analytics suite, and mentor marketplace. 12,000+ candidates. 94% success rate. Still improving.",
  },
];
    ...
    >
      ...
      <section className="relative min-h-[88vh] flex items-center justify-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="orb absolute top-[10%] left-[8%] w-80 h-80 rounded-full"
            style={{
              background:
          ...
          />
          <div
            className="orb absolute bottom-[15%] right-[6%] w-96 h-96 rounded-full"
            style={{
              background:
          ...
          />
          <div
            className="orb absolute top-[40%] right-[20%] w-64 h-64 rounded-full"
            style={{
              background:
          ...
          {/* Rotating ring */}
          <div
            className="spin absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full"
            style={{ border: "1px dashed rgba(37,99,235,0.08)" }}
          />
          <div
            className="spin absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full"
            style={{
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            {["We", "built", "the", "coach", "we", "wish", "we", "had."].map(
              (word, i) => (
                <span
                  key={i}
                  className="hero-word"
          ...
          >
            YourInterviewCoach was born from a simple frustration: talented
            people were failing interviews not because they weren't good enough
            — but because no one ever taught them how to show it.
          </p>

          {/* CTA row */}
          <div
            className="hero-word flex flex-col sm:flex-row items-center justify-center gap-3 mt-10"
            style={{ animationDelay: "750ms" }}
          >
            <Link
              href="/signup"
              className="cta-btn inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-white text-sm relative overflow-hidden"
              style={{
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-medium text-slate-600 text-sm border border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200"
            >
              Explore services
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeUp>
              ...
              <p
                ...
                style={{ fontSize: "17px" }}
              >
                Premium coaching used to be locked behind expensive bootcamps
                and who-you-know networks. A candidate in Mumbai or Pune
                shouldn't have less access to quality prep than someone whose
              ...
              <p
                ...
                style={{ fontSize: "17px" }}
              >
                We combine AI that's available at 3am before your morning
                interview with human mentors who've sat on both sides of the
                table — and we make it accessible to anyone who's serious about
                their career.
              </p>
            </FadeUp>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      "The best interview is one where the panel forgets they're
                      evaluating you — because you made them want to work with
                      you."
                    </blockquote>
            ...
            {values.map((v, i) => {
              ...
              return (
                <FadeUp key={i} delay={i * 100}>
                  <div
                    className="value-card rounded-2xl p-7 h-full"
                    style={{
                      background: "rgba(255,255,255,0.9)",
                ...
                return (
                  <FadeUp key={i} delay={i * 80}>
                    ...
                    >
                      {/* Content */}
                      <div
                        className={`flex-1 pl-14 md:pl-0 ${isRight ? "md:pr-12 md:text-right" : "md:pl-12"}`}
                      >
                        <div
                          ...
                          style={{
                            ...
                            border:
                              activeYear === i
                                ...
                                : "1.5px solid rgba(219,234,254,0.5)",
                            boxShadow:
                              activeYear === i
                        ...
                        >
                          <div className="text-xs font-bold text-blue-500 mb-1 uppercase tracking-widest">
                            {m.year}
                          </div>
                          <div
                      ...
                      <div className="absolute left-0 md:left-1/2 top-5 md:-translate-x-1/2 flex items-center justify-center">
                        <div
                          className="timeline-dot w-5 h-5 rounded-full border-2 border-blue-400 bg-white flex items-center justify-center"
        ...
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-14">
            ...
            <p
              ...
              style={{ fontSize: "16px" }}
            >
              Everyone on our team has either hired at a top company, cracked
              elite interviews themselves — or both.
            </p>
          </FadeUp>
              ...
              <FadeUp key={i} delay={i * 80}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ borderTop: "1px solid rgba(219,234,254,0.6)" }}
                  >
                    <a
                      href={member.links.linkedin}
                      className="p-1.5 rounded-lg hover:bg-blue-50 text-slate-400 hover:text-blue-600 transition-colors duration-200"
                    >
          ...
          <FadeUp>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  className="text-blue-200 mb-8 max-w-xl mx-auto leading-relaxed"
                  style={{ fontSize: "16px" }}
                >
                  Join 12,000+ candidates who chose to walk into their
                  interviews prepared, confident, and ready.
                </p>
