      ...
      <div className="space-y-6">
        <div className="text-center py-16">
          ...
          <p className="text-zinc-400 max-w-md mx-auto mb-8">
            Messaging is only available after you book a session with a mentor. Once your booking is confirmed, you can chat with your mentor here.
          </p>
          <button
            onClick={() => router.push('/')}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400 mt-2">Chat with your mentor</p>
      </div>
