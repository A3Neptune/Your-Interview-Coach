...
export const authAPI = {
  ...
  // Get all users (admin)
  getAllUsers: (params?: any) => apiClient.get("/auth/all-users", { params }),
...
export const contentAPI = {
  ...
  getCourse: (courseId: string) =>
    apiClient.get(`/content/courses/${courseId}`),

  // Get content details
  getContent: (contentId: string) =>
    apiClient.get(`/content/content/${contentId}`),
  ...
  updateCourse: (courseId: string, data: any) =>
    apiClient.put(`/content/courses/${courseId}`, data),

  // Delete course (mentor)
  deleteCourse: (courseId: string) =>
    apiClient.delete(`/content/courses/${courseId}`),

  // Add content to course (mentor)
  addContent: (courseId: string, data: any) =>
    apiClient.post(`/content/courses/${courseId}/content`, data),

  // Update content (mentor)
  updateContent: (contentId: string, data: any) =>
    apiClient.put(`/content/content/${contentId}`, data),

  // Delete content (mentor)
  deleteContent: (contentId: string) =>
    apiClient.delete(`/content/content/${contentId}`),
};
...
export const bookingAPI = {
  ...
  getMentorAvailability: (mentorId: string) =>
    apiClient.get(`/bookings/mentors/${mentorId}/availability`),
...
export const paymentAPI = {
  ...
  getInvoice: (paymentId: string) =>
    apiClient.get(`/payments/invoice/${paymentId}`),
};
...
export const pricingAPI = {
  ...
  getService: (serviceId: string) =>
    apiClient.get(`/pricing-section/public/${serviceId}`),

  // Admin methods
  createService: (data: any) =>
    apiClient.post("/pricing-section/admin/services", data),
  updateService: (serviceId: string, data: any) =>
    apiClient.put(`/pricing-section/admin/services/${serviceId}`, data),
  deleteService: (serviceId: string) =>
    apiClient.delete(`/pricing-section/admin/services/${serviceId}`),
  updateDiscount: (serviceId: string, data: any) =>
    apiClient.put(
      `/pricing-section/admin/services/${serviceId}/discount`,
      data,
    ),
};
...
export const gdBookingAPI = {
  ...
  verifyPayment: (data: any) =>
    apiClient.post("/gd-bookings/verify-payment", data),
  getMyBookings: () => apiClient.get("/gd-bookings/my-bookings"),
  adminGetAll: () => apiClient.get("/gd-bookings/admin/all"),
  adminUpdate: (bookingId: string, data: any) =>
    apiClient.put(`/gd-bookings/admin/${bookingId}`, data),
};

// Analytics API
export const analyticsAPI = {
  trackPageView: (data: { path: string; referrer?: string }) =>
