  ...
  return (
    <>
      <style>{`
        ...
        .stage:hover .frame-a { transform: rotate(0deg); }
        .stage:hover .frame-b { transform: rotate(0deg); }
        .stage:hover .photo   { transform: scale(1.02); }
        .photo { transition: transform 0.7s cubic-bezier(.23,1,.32,1); }
        ...
        .anim-scroll { animation: scrollLine 2.2s ease-in-out infinite; }
        ...
        .cta-primary:hover {
          ...
          box-shadow: 0 8px 28px rgba(29,78,216,0.30);
        }
        .cta-secondary {
      ...
      <section
        ref={sectionRef}
        className="hero-grain relative min-h-svh overflow-hidden flex flex-col"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            filter: 'blur(90px)',
            left: `calc(${mousePos.x * 100}% - 280px)`,
            top: `calc(${mousePos.y * 100}% - 280px)`,
            transition: 'left 0.6s ease, top 0.6s ease',
          }}
        />

        {/* Main layout */}
        <div className="relative z-10 flex-1 w-full max-w-[1300px] mx-auto px-6 pt-[96px] pb-20 lg:pt-[110px] lg:pb-0 grid grid-cols-1 lg:grid-cols-[52%_48%] items-center gap-12 lg:gap-0">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              ...
              <span className="text-[11.5px] font-semibold text-blue-700 tracking-[0.10em] uppercase">Interview Mentorship · 2026</span>
            </motion.div>
            ...
            >
              <Link
                href="/signup"
                className="cta-primary inline-flex items-center gap-2 px-7 py-3.5 text-white text-[13px] font-semibold tracking-[0.03em] uppercase rounded-lg no-underline"
              ...
              <button
                onClick={scrollToFeatures}
                className="cta-secondary inline-flex items-center gap-2 px-6 py-3.5 text-slate-600 text-[13px] font-medium tracking-[0.03em] uppercase rounded-lg border bg-transparent"
            ...
            <motion.div
              ...
              className="flex gap-8 mt-12 pt-8 justify-center lg:justify-start"
              style={{ borderTop: '1px solid rgba(15,23,42,0.08)' }}
            >
              {[
                { num: '12,000+', label: 'Coached' },
                { num: '94%', label: 'Success Rate' },
                { num: '4.4★', label: 'Rating' },
              ].map(({ num, label }) => (
                <div key={label}>
                  <p className="text-slate-900 leading-none" style={{ fontSize: 'clamp(22px, 2.5vw, 30px)', fontWeight: 600, letterSpacing: '-0.02em' }}>
                    {num}
                  </p>
                  <p className="text-[10.5px] font-semibold tracking-widest uppercase text-slate-400 mt-1">{label}</p>
                </div>
              ))}
            </motion.div>
          </div>
          ...
          <div className="flex items-center justify-center lg:justify-end pt-10 lg:pt-0">
            ...
            >
              <div className="relative rounded-xl overflow-hidden bg-slate-200 aspect-[4/5] cursor-pointer">
                <img
                  src="/IMG-20241116-WA0012(1).jpg.jpeg"
                  alt="Neel Aashish Seru – Interview Coach"
                  className="w-full h-full object-cover object-top block border border-black/5"
                />

                {/* Solid Name plate */}
                <div
                  className="absolute bottom-4 left-4 right-4 bg-black rounded-xl px-5 py-4 pointer-events-none"
                >
                  <p className="text-white font-semibold leading-tight" style={{ fontSize: 18 }}>
                    Neel Aashish Seru
                  </p>
                  <div className="w-6 h-0.5 rounded-full mt-2.5" style={{ background: '#2563eb' }} />
                </div>
              </div>

              {/* Float — Years */}
              <div
                className="absolute bottom-10 -right-[46px] max-lg:-right-2 text-center min-w-[80px] rounded-[10px] px-4 py-3 pointer-events-none"
                style={{
              ...
              >
                <p className="leading-none text-blue-600 font-bold" style={{ fontSize: 32 }}>10+</p>
                <p className="text-[9px] font-bold tracking-widest uppercase text-slate-400 mt-0.5">Yrs Exp</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <span className="text-[9px] font-semibold tracking-[0.20em] uppercase" style={{ color: '#bbb' }}>Scroll</span>
          <div className="anim-scroll w-px h-9" style={{ background: 'linear-gradient(to bottom,rgba(29,78,216,0.4),transparent)' }} />
        </motion.div>
