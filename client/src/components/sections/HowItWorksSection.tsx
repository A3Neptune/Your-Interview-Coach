...
const steps = [
  {
    ...
    description:
      "Set up your profile in minutes. Share your background, target role, and career goals so we can personalise every session for you.",
    highlight: "5 min setup",
  ...
  },
  {
    ...
    description:
      "Get paired directly with Neel Aashish Seru — a seasoned interview coach with 10+ years of experience helping candidates land top roles across industries.",
  ...
  },
  {
    ...
    title: "Start Sessions",
    description:
      "Book 1-on-1 video calls at times that work for you. Every session is tailored — real mock interviews, live feedback, and actionable improvement plans.",
    highlight: "Flexible times",
  ...
  },
  {
    ...
    description:
      "Walk into every interview prepared and confident. Track your growth, complete milestones, and join the 94% of candidates who get their dream role.",
...
export default function HowItWorksSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setProgress(clampedProgress);
      setActiveStep(
        Math.min(steps.length - 1, Math.floor(clampedProgress * steps.length)),
      );
    };
    window.addEventListener("scroll", handleScroll, { passive: true });
    handleScroll();
  ...
  return (
    <>
      ...
      <section
        id="how-it-works"
        ref={sectionRef}
        className="hiw-grain relative py-6 lg:py-8 px-4 sm:px-6 overflow-hidden"
        style={{
          background: "#f8f6f1",
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <div
              className="hidden lg:block absolute left-1/2 top-0 bottom-0 -translate-x-px"
              style={{ width: 1 }}
            >
              <div
              ...
              <div
                ...
                style={{
                  height: `${progress * 100}%`,
                  background:
                    "linear-gradient(to bottom, #1d4ed8, rgba(29,78,216,0.3))",
                }}
              />
            </div>
                    ...
                    <div className="hidden lg:block">
                          ...
                          style={{
                            ...
                            transform: isCurrent
                              ...
                              : isCompleted
                                ...
                                : "scale(0.92)",
                            boxShadow: isCurrent
                              ? "0 8px 28px rgba(29,78,216,0.30)"
                              : "none",
                          }}
                        >
                          {isCompleted ? (
                      ...
                      <div
                        ...
                        style={{
                          ...
                          transition:
                            "opacity 0.6s cubic-bezier(.23,1,.32,1), transform 0.6s cubic-bezier(.23,1,.32,1)",
                        }}
                      >
                        {/* MENTOR STEP — special card */}
                        {step.isMentorStep ? (
                          <div
                            className={`rounded-2xl overflow-hidden border-2 ${isCurrent ? "border-blue-300" : "border-blue-100"}`}
                            style={{
                              boxShadow: isCurrent
                                ? "0 12px 40px rgba(29,78,216,0.18)"
                          ...
                          >
                              ...
                              <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-white/50 text-[10px] tracking-wider uppercase mt-0.5">
                            ...
                            <div className="bg-white p-4">
                              ...
                              <h3
                                className="font-semibold text-slate-800 mb-1.5"
                                style={{ fontSize: 16 }}
                              >
                                {step.title}
                              </h3>
                          ...
                          >
                            <div
                              className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full mb-3 ${isLeft ? "flex-row-reverse" : ""}`}
                              style={{
                                background: isCurrent
                                  ? "rgba(29,78,216,0.08)"
                                  : "rgba(29,78,216,0.04)",
                    ...
                    <div className="lg:hidden">
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center shrink-0">
                          ...
                          {idx < steps.length - 1 && (
                            <div
                              className="w-px flex-1 my-2 relative overflow-hidden"
                              style={{ minHeight: 32 }}
                            >
                              <div
                                className="absolute inset-0"
                              ...
                              <div
                                ...
                                style={{
                                  ...
                                  background:
                                    "linear-gradient(to bottom,#1d4ed8,rgba(29,78,216,0.2))",
                                }}
                              />
                            </div>
                          )}
                        ...
                        <div className="flex-1 pb-7">
                          {step.isMentorStep ? (
                            /* Mobile mentor card */
                            <div
                              className="rounded-2xl overflow-hidden border-2 mb-1"
                              style={{
                                borderColor: isCurrent
                                  ? "rgba(29,78,216,0.28)"
                                  : "rgba(29,78,216,0.10)",
            ...
            >
              ...
              >
                ...
                <a
                  href="/signup"
                  className="text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors underline-offset-2 hover:underline"
                >
                  Book a session →
                </a>
              </div>
