        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-600 text-sm leading-relaxed max-w-md mb-4">
              ...
              guidance for career success. Learn from industry leaders and
              achieve your goals.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/dashboard"
                  className="text-slate-600 hover:text-blue-600 transition-colors text-sm flex items-center gap-2 group"
                >
