...
// GD Plan configurations
const GD_PLANS = {
  'gd-starter': { memberCount: 4, pricePerMember: 199, totalAmount: 796 },
  'gd-popular': { memberCount: 6, pricePerMember: 169, totalAmount: 1014 },
  'gd-value': { memberCount: 10, pricePerMember: 99, totalAmount: 990 },
};
...
export const getPlans = (req, res) => {
  const plans = Object.entries(GD_PLANS).map(([key, value]) => ({
    id: key,
    ...value,
  }));
